...
var num = 2000;
var noiseScale = 350, noiseStrength = 1;
var particles = [num];

function setup() {
  var canvasDiv = document.getElementById('p5-canvas');
  var canvas = createCanvas(canvasDiv.offsetWidth, 350);
  canvas.parent("p5-canvas");
  noStroke();
  for (let i = 0; i < (canvasDiv.offsetWidth / 1); i++) {
...
function windowResized() {
  var canvasDiv = document.getElementById('p5-canvas');
  resizeCanvas(canvasDiv.offsetWidth, 350);
}
function draw() {
  // background(0);
